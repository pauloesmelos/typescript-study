...
interface UserData { // propriedades não obrigatórias pois preenchemos um input por vez
    nome?: string;
    cpf?: string;
    email?: string;
}
...
const form = <HTMLFormElement>document.querySelector('#form'); // especificar aqui
form?.addEventListener('keyup', handleForm); // Erro(Nenhuma sobrecarga corresponse.. = especificar o tipo)
